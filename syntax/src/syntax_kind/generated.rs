...
impl SyntaxKind {
    ...
    pub fn is_literal(self) -> bool {
        matches!(
            self,
            STRING_LITERAL | HEX_STRING_LITERAL | DECIMAL_NUMBER_LITERAL | HEX_NUMBER_LITERAL
        )
    }
